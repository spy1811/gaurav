...
export const addClientData = createAsyncThunk('addClientData', async (data) => 
{
    ...
    const response = await axios.post('http://3.110.27.73/api/clients', formData,config);
    return response.data;
});
...
export const deleteClientData = createAsyncThunk('deleteClientData',async (id)=>{
  ...
  const response = await axios.delete('http://3.110.27.73/api/clients/'+id,config);
  return response.data;
});
...
export const UpdateClientId = createAsyncThunk('UpdateClientId',async (id)=>{
  ...
  const response = await axios.get('http://3.110.27.73/api/clients/'+id,config);
  return response.data;
});
...
export const UpdateClient = createAsyncThunk('UpdateClient',async (data)=>{
  ...
  const response = await axios.post('http://3.110.27.73/api/clients/'+data.clientId,formData, config);
  return response.data;
});
...
export const addCity = createAsyncThunk('addCity', async (data) => 
{
    ...
    const response = await axios.post('http://3.110.27.73/api/city', formData, config);
    return response.data;
});
...
export const deleteCity = createAsyncThunk('deleteCity',async (id)=>{
  ...
  const response = await axios.delete('http://3.110.27.73/api/city/'+id,config);
  return response.data;
});
...
export const UpdateCityId = createAsyncThunk('UpdateCityId',async (id)=>{
  ...
  const response = await axios.get('http://3.110.27.73/api/city/'+id,config);
  return response.data;
});
...
export const UpdateCity = createAsyncThunk('UpdateCity',async (data)=>{
  ...
  const response = await axios.post('http://3.110.27.73/api/city/'+data.cityId,formData, config);
  return response.data;
});
