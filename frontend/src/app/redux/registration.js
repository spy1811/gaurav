...
const axios = require('axios'); 
  ...
  export const fetchRoles = createAsyncThunk('fetchRoles', async () => {
    ...
    const response = await axios.get('http://3.110.27.73/api/role',config);
  ...
  export const addRole = createAsyncThunk('addRole', async (data) => 
  {
      ...
      const response = await axios.post('http://3.110.27.73/api/role', formData, config);
      return response.data;
  });
  ...
  export const deleteRole = createAsyncThunk('deleteRole',async (id)=>{
    ...
    const response = await axios.delete('http://3.110.27.73/api/role/'+id,config);
    return response.data;
  });
  ...
  export const UpdateRoleId = createAsyncThunk('UpdateRoleId',async (id)=>{
    ...
    const response = await axios.get('http://3.110.27.73/api/role/'+id,config);
    return response.data;
  });
  ...
  export const UpdateRole = createAsyncThunk('UpdateRole',async (data)=>{
    ...
    const response = await axios.post('http://3.110.27.73/api/role/'+data.roleId,formData, config);
    return response.data;
  });
