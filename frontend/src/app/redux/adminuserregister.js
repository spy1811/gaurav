...
export const addRegister = createAsyncThunk('addRegister', async (data) => 
{
    ...
    const response = await axios.post('http://3.110.27.73/api/user', formData, config);
    return response.data;
});
...
export const login = createAsyncThunk('login', async (data) => 
{
    ...
    const response = await axios.post('http://3.110.27.73/api/login', formData, {
                    headers: {
                        'Content-Type': 'multipart/form-data',
                    },
                });
...
export const logout = createAsyncThunk('logout', async (data) => {
  ...
  const response = await axios.post('http://3.110.27.73/api/logout', formData, {
    headers: {
