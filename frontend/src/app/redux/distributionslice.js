...
const axios = require('axios'); 
  ...
  export const fetchDistribution = createAsyncThunk('fetchDistribution', async () => {
    ...
    const response = await axios.get('http://3.110.27.73/api/distribution_header',config);
  ...
  export const fetchTypeDistribution = createAsyncThunk('fetchTypeDistribution', async () => {
    ...
    const response = await axios.get('http://3.110.27.73/api/distribution',config);
    return response.data;
  });
  ...
  export const fetchClient = createAsyncThunk('fetchClient', async () => {
    ...
    const response = await axios.get('http://3.110.27.73/api/clients',config);
    return response.data;
  });
  ...
  export const addDistribution = createAsyncThunk('addDistribution', async (data) => 
  {
      ...
      const response = await axios.post('http://3.110.27.73/api/distribution_header', formData, config);
  ...
  export const addDistributionLine = createAsyncThunk('addDistributionLine', async (data) => 
  {
      ...
      const response = await axios.post('http://3.110.27.73/api/distribution_lines', formData, config);
      return response.data;
  });
  ...
  export const fetchDistributionId = createAsyncThunk('fetchDistributionId',async (id)=>{
    ...
    const response = await axios.get('http://3.110.27.73/api/distribution_header/'+id,config);
    return response.data;
  });
  ...
  export const fetchDistributionListId = createAsyncThunk('fetchDistributionListId',async (id)=>{
    ...
    const response = await axios.get('http://3.110.27.73/api/distribution_lines/'+id,config);
    return response.data;
  });
  ...
  export const EditPlan = createAsyncThunk('EditPlan',async (data)=>{
    ...
    const response = await axios.post('http://3.110.27.73/api/distribution_lines/'+data.distributionId,formData, config);
    return response.data;
  });
  ...
  export const deleteDistributionHeader = createAsyncThunk('deleteDistributionHeader',async (id)=>{
    ...
    const response = await axios.delete('http://3.110.27.73/api/distribution_header/'+id,config);
    return response.data;
  });
  ...
  export const fetchDrivers = createAsyncThunk('fetchDrivers', async () => {
    ...
    const response = await axios.get('http://3.110.27.73/api/driver',config);
    return response.data;
  });
  ...
  export const fetchVehicle = createAsyncThunk('fetchVehicle', async () => {
    ...
    const response = await axios.get('http://3.110.27.73/api/vehiclefleet',config);
  ...
  export const fetchTruckCategory = createAsyncThunk('fetchTruckCategory', async () => {
    ...
    const response = await axios.get('http://3.110.27.73/api/truckcategory',config);
    return response.data;
  });
  ...
  export const fetchCity = createAsyncThunk('fetchCity', async () => {
    ...
    const response = await axios.get('http://3.110.27.73/api/city',config);
    return response.data;
  });
  ...
  export const fetchStatusDistribution = createAsyncThunk('fetchStatusDistribution', async () => {
    ...
    const response = await axios.get('http://3.110.27.73/api/statusdistribution',config);
    return response.data;
  });
  ...
  export const addImport = createAsyncThunk('addImport', async (data) => 
  {
      ...
      const response = await axios.post('http://3.110.27.73/api/import', formData, config);
...
//     const response = await axios.get('http://3.110.27.73/api/role/'+id);
//     return response.data;
//   });
  ...
  export const addPlan = createAsyncThunk('addPlan',async (data)=>{
    ...
    const response = await axios.post('http://3.110.27.73/api/distribution_header/'+data.distributionId,formData, config);
    return response.data;
  });
  ...
  export const addMap = createAsyncThunk('addMap', async (data) => 
  {
      ...
      const response = await axios.post('http://3.110.27.73/api/mapping', formData, config);
      return response.data;
  });
