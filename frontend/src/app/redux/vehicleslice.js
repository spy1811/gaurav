...
const axios = require('axios'); 
  ...
  export const addTruckCategory = createAsyncThunk('addTruckCategory', async (data) => 
  {
      ...
      const response = await axios.post('http://3.110.27.73/api/truckcategory', formData, config);
      return response.data;
  });
  ...
  export const deleteTruckCategory = createAsyncThunk('deleteTruckCategory',async (id)=>{
    ...
    const response = await axios.delete('http://3.110.27.73/api/truckcategory/'+id,config);
    return response.data;
  });
  ...
  export const UpdateTruckCategoryId = createAsyncThunk('UpdateTruckCategoryId',async (id)=>{
    ...
    const response = await axios.get('http://3.110.27.73/api/truckcategory/'+id,config);
    return response.data;
  });
  ...
  export const UpdateTruckCategory = createAsyncThunk('UpdateTruckCategory',async (data)=>{
    ...
    const response = await axios.post('http://3.110.27.73/api/truckcategory/'+data.truckCategoryId,formData, config);
    return response.data;
  });
  ...
  export const addVehicle = createAsyncThunk('addVehicle', async (data) => 
  {
      ...
      const response = await axios.post('http://3.110.27.73/api/vehiclefleet', formData, config);
      return response.data;
  });
  ...
  export const deleteVehicle= createAsyncThunk('deleteVehicle',async (id)=>{
    ...
    const response = await axios.delete('http://3.110.27.73/api/vehiclefleet/'+id,config);
    return response.data;
  });
  ...
  export const UpdateVehicleId = createAsyncThunk('UpdateVehicleId',async (id)=>{
    ...
    const response = await axios.get('http://3.110.27.73/api/vehiclefleet/'+id,config);
  ...
  export const UpdateVehicle = createAsyncThunk('UpdateVehicle',async (data)=>{
    console.log("UpdateVehicle Data : ",data)
      ...
      const response = await axios.post('http://3.110.27.73/api/vehiclefleet/'+data.vehicleId,formData, config);
      return response.data;
  });
