...
export const addDrivers = createAsyncThunk('addDrivers', async (data) => 
{
    ...
    const response = await axios.post('http://3.110.27.73/api/driver', formData, config);
    return response.data;
});
...
export const deleteDriverData = createAsyncThunk('deleteDriverData',async (id)=>{
  ...
  const response = await axios.delete('http://3.110.27.73/api/driver/'+id,config);
  return response.data;
});
...
export const UpdateDriverId = createAsyncThunk('UpdateDriverId',async (id)=>{
    ...
    const response = await axios.get('http://3.110.27.73/api/driver/'+id,config);
    return response.data;
  });
...
export const UpdateDrivers = createAsyncThunk('UpdateDrivers',async (data)=>{
    ...
    const response = await axios.post('http://3.110.27.73/api/driver/'+data.driverId,formData, config);
      return response.data; 
  });
