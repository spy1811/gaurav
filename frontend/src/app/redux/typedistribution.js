...
const axios = require('axios'); 
  ...
  export const fetchMap= createAsyncThunk('fetchMap', async () => {
    ...
    const response = await axios.get('http://3.110.27.73/api/mapping',config);
    return response.data;
  });
  ...
  export const addTypeDistribution= createAsyncThunk('addTypeDistribution', async (data) => 
  {
      ...
      const response = await axios.post('http://3.110.27.73/api/distribution', formData, config);
      return response.data;
  });
  ...
  export const deleteTypeDistribution = createAsyncThunk('deleteTypeDistribution',async (id)=>{
    ...
    const response = await axios.delete('http://3.110.27.73/api/distribution/'+id,config);
    return response.data;
  });
  ...
  export const UpdateTypeDistributionId = createAsyncThunk('UpdateTypeDistributionId',async (id)=>{
    ...
    const response = await axios.get('http://3.110.27.73/api/distribution/'+id,config);
    return response.data;
  });
  ...
  export const UpdateTypeDistribution = createAsyncThunk('UpdateTypeDistribution',async (data)=>{  
    ...
    const response = await axios.post('http://3.110.27.73/api/distribution/'+data.type_id,formData, config);
    return response.data;
  });
